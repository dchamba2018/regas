            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              ...
              <div class="dropdown no-arrow" id='print'>
                  <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-users-cog fa-sm fa-fw text-gray-400"></i> Seleccione un horario!
                  </a>
                  <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                    <div class="dropdown-header">Horarios:</div>
                    <?php 
                      if(count($listaHorarios)>0){
                        foreach ( $listaHorarios as $item){
                          echo "<a class='dropdown-item' href='#' onclick='cargarReporte(".$item['id'].")'>".strtoupper($item['nombre'])."</a>";
                        }
                      }
                    ?>
                  </div>
                ...
                <div class="table-reponsive">
                  ...
                  <thead>
                    <tr style="font-size: 12px; font-weight: bold;">
                      ...
                      <th title="Vacaciones en días Laborables">VDL</th>
                      <th title="Total de vacaciones">Vacaciones</th>
                      <th>Total</th>
                    </tr>
                  </thead>
...
include "logout.php";
 ?>
  ...
  <script src="metodos/metgrupales.js"></script>
